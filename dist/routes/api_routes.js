...
import { getAllUsers, getUserById, createNewUser, updateUserById, deleteUserById, addFriendToUserFriendList, removeFriendFromUserFriendList, getAllThoughts, getSingleThoughtById, createThoughtForUserById, updateThoughtById, removeThoughtById, createReactionForThought, removeReactionFromThoughtByReactionId } from '../controllers/api_controller.js';
const router = Router();
